...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      contract_items: {
        Row: {
          billing_frequency: Database["public"]["Enums"]["billing_frequency"] | null;
          catalog_item_id: string | null;
          contract_id: string;
          description: string;
    ...
    Enums: {
      ...
      asset_status:
        ...
        | "returned"
        | "inactive";
      billing_frequency: "one_time" | "monthly" | "quarterly" | "semiannual" | "annual";
      billing_status: "open" | "partial" | "paid" | "overdue" | "cancelled";
      catalog_item_type: "product" | "service" | "kit" | "rental" | "manufactured";
      contract_status: "draft" | "active" | "suspended" | "expired" | "cancelled";
      contract_type: "sale_installation" | "rental" | "subscription" | "support" | "mixed";
      customer_type: "pf" | "pj";
      generic_status: "active" | "inactive";
      lead_status: "novo" | "contatado" | "qualificado" | "perdido" | "convertido";
      opportunity_stage: "novo" | "qualificado" | "proposta" | "negociacao" | "ganho" | "perdido";
      order_status:
        | "open"
        | "approved"
        | "invoiced"
      ...
      ticket_status: "new" | "in_progress" | "waiting_customer" | "resolved" | "cancelled";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      service_priority: ["low", "medium", "high", "urgent"],
      service_type: ["installation", "maintenance", "removal", "support", "inspection", "training"],
      stock_movement_type: [
        "in",
        "out",
        "transfer",
